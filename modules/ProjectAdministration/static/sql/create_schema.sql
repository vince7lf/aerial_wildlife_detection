...
COMMENT ON COLUMN {id_labelclassGroup}.id IS 'id is the AIDE internal UUID of the group; the labelclass refers to it; autogenerated, not null; part of the original AIDE schema; i.e: "27e2ceb3-449c-11ec-a197-fa163e42617b"';
COMMENT ON COLUMN {id_labelclassGroup}.name IS 'name is the VASCAN "Rang"; string, not null; part of the original AIDE schema; i.e. "Sous espèce"';
...
COMMENT ON COLUMN {id_labelclass}.id IS 'id is the AIDE internal UUID of the label; the image/tile refer to it; autogenerated, not null; part of the original AIDE schema; i.e: "27e2ceb3-449c-11ec-a197-fa163e42617b"';
...
COMMENT ON COLUMN {id_labelclass}.color IS 'color is the background color of the label when it is selected in the AIDE labelizing interface; string representing the hexadecimal value of the color; can be null in which case the AIDE interface will define a value, default is "#095797"; part of the original AIDE schema';
