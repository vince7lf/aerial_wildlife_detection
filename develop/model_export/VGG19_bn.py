...
if __name__ == '__main__':
    ...
    if isinstance(checkpoint, OrderedDict):
        ...
        if 'state_dict' in checkpoint :
            ...
            model = resnet18()
            model.fc = nn.Linear(in_features=model.fc.in_features, out_features=len(checkpoint['model']['fc.bias']))
    ...
    # labelclasses = ["Classe1","Classe2"]

    # description = marketplace_metadata.parse_argument('--description', args.description, target_type=str, check_for_file_path=True)
    description = "<a href=\"https://arxiv.org/abs/1409.1556\" target=\"_blank\">VGG</a>-16 image classification model, trained on the <a href=\"https://ieeexplore.ieee.org/document/5206848\" target=\"_blank\">ImageNet</a> dataset challenge."
    ...
    citation_info = "VGG:<br /><p class=\"citation\">Simonyan, K. and Zisserman, A., 2014. Very deep convolutional networks for large-scale image recognition. arXiv preprint arXiv:1409.1556.</p><br />ImageNet:<br/><p class=\"citation\">Deng, J., Dong, W., Socher, R., Li, L.J., Li, K. and Fei-Fei, L., 2009, June. ImageNet: A large-scale hierarchical image database. In 2009 IEEE conference on computer vision and pattern recognition (pp. 248-255).</p>"
    ...
    baseConfigFile = os.path.join(os.getcwd(),
                                  'ai/models/detectron2/_functional/configs/labels/vgg19_bn_ImageNet.yaml')
    cfg.merge_from_file(baseConfigFile)

    cfg.MODEL.META_ARCHITECTURE = 'TorchvisionClassifier'
    cfg.MODEL.BACKBONE.NAME = 'VGG19_bn'
